...
| `n8n/` | 1.1 | **Load before building an automation, and before agreeing it needs one.** The four-way decision that comes first, naming, credentials, testing for real instead of trusting a green tick, and the failures that cost the most time |

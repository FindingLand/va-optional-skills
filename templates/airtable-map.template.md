...
Values the skills will otherwise ask you for every single session. Fill in what you know, leave the
rest, and your assistant will offer to add a line here the first time it needs one.

| Convention | Your answer |
|---|---|
| Timezone | |
| Currency | |
| How you prorate a partial month | |
| How far ahead to flag an expiring insurance policy | |
| How far ahead to flag an expiring vendor certificate | |
| What a complete application looks like | |
| Your screening criteria | |
| How you name documents | |
| What paperwork a contractor must file before payment | |
